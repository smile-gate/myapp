...
def generate_reason(model_name, values, prediction, proba):
    ...
    risk_map = {
        ...
        "진단항목29": "해당 겸업 활동이 사회 통념상 회사의 명예나 이미지를 실추시킬 우려가 있음",
        "진단항목30": "직무 수행 중 취득한 비밀을 누설하거나 누설할 우려가 있어 기밀 보호 측면에서 중대한 위반에 해당할 수 있음",
        "진단항목36": "실질적 운영자와 명의자가 다른 구조는 투명성 측면에서 허용 기준에 부합하지 않음",
        "진단항목37": "4대보험 취득이 수반되는 이중취업은 회사 내부 규정 및 겸업 허용 기준과의 부합 여부를 추가 검토할 필요가 있음",
